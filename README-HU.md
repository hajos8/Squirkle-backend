...
Összefoglalás: Az összes aktív piactéri hirdetés listázása.
...
Összefoglalás: Az összes inaktív piactéri hirdetés listázása.
...
Összefoglalás: Piactéri hirdetés létrehozása.
...
Összefoglalás: Piactéri hirdetés törlése.
...
Összefoglalás: Aktív piactéri hirdetés megvásárlása.
...
```<!-- filepath: c:\Users\User\Documents\bandi\Squirkle-backend\README-HU.md -->
# Squirkle Backend API
...
- `user-items`
    - felhasználónkénti tulajdonolt tárgy példányok
- `listings`
    - piactéri hirdetések (`active`, `price`, `userId`, `itemId`, `userItemId`, stb.)
- `metadatas`
    - megosztott metaadat bejegyzések tárgy stílus/ritkaság-szerű adatokhoz
- `areas`
    - megvásárolható világ/zóna bejegyzések (`name`, `imageUrl`, `price`)
...
- A CORS globálisan engedélyezve van.
- A kérés tartalmának feldolgozása támogatja a JSON és URL-kódolt törzseket.
- A Cloudinary és Firebase konfigurációs értékek naplózásra kerülnek indításkor (.env fájl tartalma nem lesz kiírva)